            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nin" class="col-md-4 col-form-label text-md-end">{{ __('Numéro d\'identification nationale') }}</label>

                            <div class="col-md-6">
                                <input id="nin" type="text" class="form-control @error('nin') is-invalid @enderror" name="nin" value="{{ old('nin') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-select @error('role') is-invalid @enderror" name="role" required>
                                    ...
                                    <option value="voter" {{ old('role') == 'voter' ? 'selected' : '' }}>Électeur</option>
                        ...
                        <div class="row mb-3">
                            <label for="region_id" class="col-md-4 col-form-label text-md-end">{{ __('Région') }}</label>
