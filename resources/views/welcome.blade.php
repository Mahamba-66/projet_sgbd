                ...
                <div class="col-lg-8">
                    <div class="glass-card">
                        ...
                        <div class="d-flex gap-3">
                            <a href="{{ route('register.candidate') }}" class="btn btn-custom btn-custom-primary">S'inscrire en tant que candidat</a>
                            <a href="{{ route('register.voter') }}" class="btn btn-custom btn-custom-outline">S'inscrire en tant qu'électeur</a>
                        </div>
                    </div>
                </div>
            </div>
